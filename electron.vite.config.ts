    ...
    build: {
      ...
      rollupOptions: {
        ...
        input: {
          ...
          // CLI installs must remain usable after Electron replaces out/main.
          'skills/skill-provider-runtime-roots': resolve(
            'src/main/skills/skill-provider-runtime-roots.ts'
          ),
          'skills/bundled-agent-skill-install': resolve(
            'src/main/skills/bundled-agent-skill-install.ts'
          )
        },
