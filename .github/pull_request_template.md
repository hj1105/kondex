...
<!-- State which AI model, if any, assisted with the change. -->

## Review

## Agent skill installer upstream boundary

- [ ] Not applicable, or this change follows `docs/reference/agent-skill-installation-upstream-boundary.md` and copies or mechanically translates no upstream skill-installer source, tests, fixtures, registry entries, path tables, comments, or documentation.

## Notes

Ensure no issues in: security, cross-platform support (Linux, Windows, macOS), remote SSH, backwards compatibility, or performance.
