...
export type RasterTerminalInternals = {
  _core?: {
    _themeService?: {
      colors?: { ansi?: { rgba?: number }[]; background?: { rgba?: number } }
    }
...
async function readActiveTerminalRasterTarget(page: Page): Promise<TerminalRasterTarget> {
  return page.evaluate(() => {
    ...
    const terminalCore = (pane.terminal as typeof pane.terminal & RasterTerminalInternals)._core
