...
test.describe('Terminal Shortcuts', () => {
  ...
  test('Ctrl+Enter protects local ConPTY shells and preserves other host chords', async ({
    orcaPage,
    electronApp
  }) => {
    await installMainProcessPtyWriteSpy(electronApp)
    ...
    // Preserve the established CSI-u fallback outside local ConPTY.
