...
describe('skill bundle manifest generator', () => {
  ...
  it('computes the same Git tree identity as Git for the current Kondex CLI package', async () => {
    const packageRoot = await createPackage()
    await cp(path.resolve('skills', 'kondex-cli'), packageRoot, { recursive: true })
