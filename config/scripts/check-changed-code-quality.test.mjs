...
describe('changed-code quality line matching', () => {
  ...
  // Pinning --config would override directory-specific rule choices.
  ...
  it('has no retired Cloud exemption from the root quality checks', () => {
    expect(isRootCodeQualityPath('cloud/apps/relay/src/index.ts')).toBe(true)
