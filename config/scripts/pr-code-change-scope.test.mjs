...
describe('docs-only path classification', () => {
  it('treats documentation-only changes as docs-only', () => {
    expect(shouldRunPrChecks(['README.md', 'docs/reference/git-compatibility.md'])).toBe(false)
  })
...
describe('per-job path classification', () => {
  ...
  it('skips every expensive job for docs-only diffs', () => {
    expectClassification(['README.md', 'docs/reference/git-compatibility.md'], {})
  })
