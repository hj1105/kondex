...
const TaskPage = lazy(() => import('../components/kontext/KontextTaskPage'))
        ...
        <div className="flex flex-col flex-1 min-w-0 min-h-0">
          ...
          <div className="flex flex-row flex-1 min-h-0 overflow-hidden">
            ...
            <div className="flex flex-col flex-1 min-w-0 min-h-0 overflow-hidden">
              {/* Why: automations own their page header; the stacked titlebar would be an empty 36px stripe. */}
                ...
                <div className="flex flex-1 min-w-0 min-h-0 flex-col">
                  ...
                  <Suspense fallback={null}>
                    <RecoverableRenderErrorBoundary
                      ...
                      description={translate(
                        'auto.App.03a14f6b5b',
                        'Retry the page or navigate to another Kondex surface.'
                      )}
                    >
