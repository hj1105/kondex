...
export function HostRemoveDialog({
  ...
  const description =
    target.kind === 'runtime'
      ? translate(
          ...
          'This opens the Kondex servers settings where you can remove this server.'
        )
      : hasWorkspaces
        ? translate(
            'auto.components.sidebar.HostRemoveDialog.hostHasWorkspacesDefault',
            'Removes {{value0}} and its credentials from this computer. Its {{value1}} stay in Kondex — remote files are not touched.',
  ...
  const deleteOptionLabel = isConnected
    ...
    : translate(
        ...
        'Also remove these {{value0}} from Kondex',
                    ...
                    <span className="mt-0.5 block text-muted-foreground">
                      {isConnected
                        ...
                        : translate(
                            ...
                            'Clears them from Kondex only. Remote files, worktrees, and branches are left untouched.'
                          )}
                    </span>
                  </span>
                </div>
