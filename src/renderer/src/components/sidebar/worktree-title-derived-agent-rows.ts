...
function buildTitleDerivedAgentRow(args: {
  ...
  // Keep title normalization aligned with the pane's launch owner.
  ...
  // Hook-less Codex over SSH can surface only decorated task titles; fall back to the pane's known owner instead
...
/**
 * Determines the agent type from a terminal title and its authoritative owner.
 */
