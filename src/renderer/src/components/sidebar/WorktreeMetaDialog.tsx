...
const WorktreeMetaDialog = React.memo(function WorktreeMetaDialog() {
  ...
  const { worktree, linkedIssue, currentIssue, currentProvider, isFolderWorkspace, liveLinks } =
  ...
  const issueProvider: IssueLinkProvider = 'github'
  ...
  if (isOpen && !prevIsOpenRef.current) {
    ...
    // A background metadata write while the dialog is open would otherwise move
    // it, making the untouched field read as dirty and overwriting the new link.
    setSnapshot({
