...
function openWorkspaceCreationComposer(): void {
  useAppStore.getState().openModal('new-workspace-composer', { telemetrySource: 'sidebar' })
}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              onClick={openWorkspaceCreationComposer}
              aria-label={translate(
