...
export function WorktreeIssueLinkField(props: WorktreeIssueLinkFieldProps): React.JSX.Element {
  ...
  const inputId = useId()
  const label = translate('auto.components.sidebar.WorktreeIssueLinkField.5b440069e6', 'GitHub')
      ...
      <div className="relative">
        <Input
          ...
          placeholder={translate(
            ...
            'Issue # or GitHub issue URL'
          )}
          className="h-8 text-xs"
          style={{ paddingRight: issueAdornmentReserve(label) }}
        />
        <div className="absolute right-1 top-1 flex items-center gap-0.5">
          <span className="flex h-6 items-center gap-1 px-1 text-[10px] font-medium text-muted-foreground">
