...
// Why: the context-menu "Move to Status" routes to the board callback when one
// is wired, else a local-only write of only the status-changed worktrees. Extracted
// pure so the routing and the
