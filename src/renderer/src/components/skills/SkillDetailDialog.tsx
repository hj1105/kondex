...
/** Agent names come from the roots that reached the file, so a skill discovered through
 *  several agent roots lists all of them rather than the coarse provider tag. */
function agentNames(
