  ...
  switch (chip) {
    ...
    case 'newer':
      return translate(
        ...
        'This copy is a later version than the one this build of Kondex ships.'
      )
    case 'unrecognized':
      return translate(
    ...
    case 'inaccessible':
      return translate(
        ...
        'Kondex couldn’t read this copy (a permissions or file error).'
      )
    case 'duplicate':
      return translate(
    ...
    case 'external-link':
      return translate(
        ...
        'A shortcut pointing outside Kondex’s skill folders.'
      )
    case 'broken-link':
      return translate(
