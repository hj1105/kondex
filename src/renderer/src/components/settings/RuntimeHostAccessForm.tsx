        ...
        <ol className="ml-4 list-decimal space-y-1 text-xs text-muted-foreground">
          <li>
            {translate(
              ...
              'Open Settings → Remote Hosts → Share this host.'
            )}
          </li>
          <li>
            {translate(
          ...
          <li>
            {translate(
              ...
              'Generate the link, then copy the “Pair another Kondex client” link.'
            )}
          </li>
        </ol>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-[minmax(0,180px)_minmax(0,1fr)]">
        <div className="space-y-2">
          <Label htmlFor="runtime-server-name">
            {translate('auto.components.settings.RuntimeHostAccessForm.name', 'Name in Kondex')}
          </Label>
          <Input
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'This only changes how the computer appears in Kondex.'
            )}
          </p>
        </div>
        <div className="space-y-2">
          ...
          <p id="runtime-server-access-link-help" className="text-xs text-muted-foreground">
            {translate(
              ...
              'Kondex shows the destination before connecting. Credentials stay hidden.'
            )}
          </p>
          {inputError ? (
          ...
          <div className="text-sm font-medium text-destructive">
            {failure.kind === 'host-identity-mismatch'
              ? translate(
                  ...
                  'The reached Kondex host does not match this access link'
                )
              : failure.kind === 'access-link-invalid'
                ...
                : failure.kind === 'protocol-incompatible'
                  ? translate(
                      ...
                      'Kondex versions are not compatible'
                    )
