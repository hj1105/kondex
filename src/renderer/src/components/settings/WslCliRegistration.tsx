...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'kondex'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `kondex` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Kondex itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Kondex will register {{value0}} so the command works from WSL terminals.',
