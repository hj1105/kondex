      ...
      <div className="space-y-0.5">
        ...
        <p className="text-xs text-muted-foreground">
          {translate(
            ...
            'Create access links for browsers or another desktop client to connect back to this running app.'
          )}
        </p>
      </div>
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Create a revocable access grant so a browser or another Kondex client can connect.'
              )}
            </p>
          </div>
          <Button
