...
const EXAMPLE_PROMPTS: string[] = [
  'Using Kondex CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open project board with the Kondex CLI and tell me what's blocked.",
  'With Kondex CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
    ...
    <div className="rounded-xl border border-border/60 bg-card/50 p-4">
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        {translate(
          ...
          'Paste any of these into Claude Code or Codex in a project where the skill is installed.'
        )}
      </p>
