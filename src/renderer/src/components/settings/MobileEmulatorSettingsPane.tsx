...
import { AndroidLogo, IosBrandIcon } from '../emulator-pane/MobilePlatformBrandIcons'
  ...
  const defaultDeviceDescription = useMemo(() => {
    if (devices.length === 0) {
      return translate(
        ...
        'Kondex will auto-select an emulator device after devices are detected.'
      )
    }
    return translate(
    ...
    <div className="space-y-4">
      <SearchableSetting
        ...
        description={translate(
          ...
          'Configure mobile emulator support for Kondex and coding agents.'
        )}
