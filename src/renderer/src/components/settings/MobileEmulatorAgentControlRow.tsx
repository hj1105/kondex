        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Let coding agents control the active mobile emulator with Kondex CLI commands.'
            )}
          </p>
        </div>
        <span
          ...
          <div className="min-w-0 flex-1 space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Registers the Kondex CLI command so agents can control the active emulator from their shell.'
              )}
            </p>
        ...
        <div className={cn('py-3', setup.step2Blocked && 'opacity-60')}>
          <BundledAgentSkillSetupPanel
            ...
            description={translate(
              ...
              'Enables agents to use Kondex CLI commands, including mobile emulator control.'
            )}
            ...
            runtimeOverride={{
              agentRuntime: {
                runtime: 'host',
                label: translate('kondex.thisDevice', 'This device')
              },
