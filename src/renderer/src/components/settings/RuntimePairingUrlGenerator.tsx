...
export function RuntimePairingUrlGenerator({
  ...
  const loadRuntimeAccessGrants = useCallback(
    async (options: { showToastOnError?: boolean } = {}): Promise<void> => {
      ...
      try {
        const result = await window.api.runtimeEnvironments.listLocalAccessGrants()
  ...
  const loadNetworkInterfaces = useCallback(
    async (options: { showToastOnError?: boolean } = {}): Promise<void> => {
      ...
      try {
        const result = await window.api.runtimeEnvironments.listLocalNetworkInterfaces()
  ...
  const generateRuntimePairingUrl = async (): Promise<void> => {
    ...
    try {
      const result = await window.api.runtimeEnvironments.createLocalAccessLink({
        address,
        rotate: true,
  ...
  const revokeRuntimeAccess = async (grant: RuntimeAccessGrant): Promise<void> => {
    ...
    try {
      const result = await window.api.runtimeEnvironments.revokeLocalAccessGrant({
