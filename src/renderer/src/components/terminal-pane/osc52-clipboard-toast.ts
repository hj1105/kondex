  ...
  toast.info(
    ...
    ),
    {
      description: translate(
        ...
        'Enable TUI clipboard writes in Terminal settings to copy from SSH, Zellij, tmux, Neovim, fzf, Claude, or Codex.'
      ),
      duration: 12_000,
      action: {
        label: translate(
  ...
  toast.error(
    ...
    ),
    {
      description: translate(
        ...
        'The terminal app requested a copy, but Kondex could not confirm that it reached the system clipboard.'
      ),
      duration: 12_000
    }
  )
