...
describe('TabBarCreateEntry tab results', () => {
  ...
  it('orders tab rows above menu actions, agents and file entries', () => {
    entryOptionsMock.options = [existingFileOption('src/cod.ts')]
    tabSearchMock.resultsByQuery['cod'] = [terminalResult({ title: 'cod tab' })]
    const menuOptions: TabCreateMenuOption[] = [
      { id: 'new-browser', kind: 'new-browser', keywords: ['cod'], label: 'New Browser Tab' }
    ]
