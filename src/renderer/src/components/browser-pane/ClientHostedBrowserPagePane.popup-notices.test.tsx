...
describe('ClientHostedBrowserPagePane popup notices', () => {
  it('names the origin whose popup was refused', () => {
    ...
    expect(toastMocks.message).toHaveBeenCalledWith(
      'https://accounts.example.com tried to open a popup Kondex does not support here.',
  ...
  it('reports where a popup Kondex did open actually went', () => {
    renderPane()
    ...
    expect(toastMocks.message).toHaveBeenNthCalledWith(
      1,
      'https://accounts.example.com opened a new page in Kondex.',
