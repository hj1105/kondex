...
describe.each([
  ...
  // A completed adoption must not revive removed feature tracking.
  // The actual client attachment is checked independently below.
  it('adopts a connecting pane without reviving feature tracking', () => {
