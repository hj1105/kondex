...
> = {
  ...
  fork_head_unsupported: {
    ...
    body: {
      ...
      fallback: 'Kondex cannot create a {{reviewLabel}} from this fork head here.'
    }
  },
  base_not_on_remote: {
    title: {
  ...
  unsupported_provider: {
    ...
    body: {
      ...
      fallback: 'This repository provider does not support creating a {{reviewLabel}} from Kondex.'
    }
  }
}
  ...
  if (reason === 'existing_review') {
    ...
    return {
      ...
      description: translate(
        ...
        'Kondex found an existing {{reviewLabel}} for this branch.',
        { reviewLabel }
      ),
      composerMode: 'hidden',
      workflowAction: null,
...
> = {
  ...
  auth_required: {
    ...
    body: {
      ...
      fallback:
        '{{provider}} must be connected in this environment before Kondex can create a {{reviewLabel}}.'
    },
    workflow: null
  }
}
