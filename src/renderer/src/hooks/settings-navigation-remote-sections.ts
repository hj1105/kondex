...
export function buildRemoteSettingsSections(
  ...
  return [
    ...
    {
      id: 'servers',
      title: translate('auto.hooks.useSettingsNavigationMetadata.de0c2907a1', 'Remote Hosts'),
      description: isWebClient
        ? 'Connect this browser to a saved remote host.'
        : 'Pair remote Kondex runtimes for persistent sessions and browser or desktop access.',
      icon: Server,
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'Install and manage experimental Kondex plugins.'
            ),
            icon: Blocks,
    ...
    // multiple hosts (local + a remote host, or two clones) collapses to
