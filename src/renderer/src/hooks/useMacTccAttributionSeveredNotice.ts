      ...
      try {
        ...
        toast.warning(
          translate(
            ...
            'macOS permissions may not reach Kondex terminals'
          ),
          {
            id: SEVERED_TCC_NOTICE_ID,
            description: translate(
              'auto.hooks.useMacTccAttributionSeveredNotice.description',
              'Running Kondex terminals are hosted by a daemon started by a previous Kondex installation. macOS may not apply Kondex’s Accessibility, Automation, or protected-file permissions to them. Restart the daemon from Manage Sessions to restore access. This will close all running Kondex terminals.'
            ),
            duration: Infinity,
            action: {
              label: translate(
