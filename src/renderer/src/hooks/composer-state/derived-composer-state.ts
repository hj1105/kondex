...
export function useDerivedComposerState(input: DerivedComposerStateInput) {
  ...
  // Provider-backed items without repository issue numbers bypass repository templates.
  ...
  // Provider-backed items without repository issue numbers cannot use legacy {{issue}} templates.
