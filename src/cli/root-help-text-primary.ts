export const ROOT_HELP_TEXT_PRIMARY = [
  'kondex',
  '',
  'Usage: kondex <command> [options]',
  '',
  'Startup:',
  '  open                      Launch Kondex and wait for the runtime to be reachable',
  '  serve                     Start a headless Kondex runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Kondex and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Kondex CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Kondex skills globally via the community skills CLI',
  '  skills update             Update already-installed Kondex skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Kondex runtime from a pairing code',
  '  environment list          List saved remote Kondex runtimes',
  '  environment show          Show one saved remote Kondex runtime',
  '  environment rm            Remove a saved remote Kondex runtime',
  '',
  'Automations:',
  '  automations list          List scheduled Kondex automations',
  '  automations show          Show one Kondex automation',
  '  automations create        Create a scheduled Kondex automation',
  '  automations edit          Edit a Kondex automation',
  '  automations remove        Remove a Kondex automation and its run history',
  '  automations run           Run a Kondex automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Kondex',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Kondex',
  '  repo add                  Add a project to Kondex by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Kondex-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Kondex-managed worktree for the current directory',
  '  worktree create           Create a new Kondex-managed worktree',
  '  worktree set              Update Kondex metadata for a worktree',
  '  worktree rm               Remove a worktree from Kondex and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Kondex editor',
  '  file diff                 Open a workspace file diff in the Kondex editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Kondex-managed terminals',
  ...
  '  emulator list             List available/running emulators (Kondex-managed + raw serve-sim)',
