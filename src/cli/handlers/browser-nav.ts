...
// round-trip, even when Kondex is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "Kondex is not running" by the
