...
describe('orchestration recovery command identity', () => {
  it.each([
    ...
    ['dev checkout', { ORCA_DEV_REPO_ROOT: '/repo' }, 'darwin', 'kondex-dev'],
    ['Kondex dev checkout', { KONDEX_DEV_REPO_ROOT: '/repo' }, 'darwin', 'kondex-dev'],
    ['configured Kondex', { KONDEX_CLI_COMMAND: 'kondex-dev' }, 'darwin', 'kondex-dev'],
    [
      'Kondex override priority',
      { KONDEX_CLI_COMMAND: 'kondex', ORCA_CLI_COMMAND: 'orca' },
      'darwin',
      'kondex'
    ],
    ['packaged Linux', {}, 'linux', 'kondex'],
    ['local macOS', {}, 'darwin', 'kondex'],
    ['local Windows', {}, 'win32', 'kondex']
