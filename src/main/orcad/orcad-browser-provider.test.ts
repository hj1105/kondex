...
describe('cross-platform browser provider paths', () => {
  it('resolves installed Electron launchers on macOS, Linux, and Windows', () => {
    expect(installedElectronCandidates('darwin', '/Users/test', {})).toEqual([
      '/Applications/Kondex.app/Contents/MacOS/Kondex',
      '/Users/test/Applications/Kondex.app/Contents/MacOS/Kondex'
    ])
    // The installer puts the CLI shim at /usr/bin/kondex, not the Electron binary.
    expect(installedElectronCandidates('linux', '/home/test', {})).toEqual([
      '/opt/Kondex/kondex',
      '/opt/kondex/kondex'
    ])
    expect(
      ...
      'C:\\Users\\test\\AppData\\Local\\Programs\\Kondex\\Kondex.exe',
      'C:\\Program Files\\Kondex\\Kondex.exe'
    ])
  })
