...
describe('daemon process inspection', () => {
  ...
  // Several daemon-v<N>.pid records can name the same app version; their merged verdict must
  // preserve the most conservative liveness result regardless of record order.
