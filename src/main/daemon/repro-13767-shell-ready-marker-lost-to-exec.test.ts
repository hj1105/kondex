...
import { REAL_SHELL_TEST_BUDGET_MS, REAL_SHELL_WAIT_MS } from '../pty/real-shell-fixture-budgets'
...
function waitForCondition(isDone: () => boolean, timeoutMs = REAL_SHELL_WAIT_MS): Promise<void> {
  return new Promise<void>((resolve, reject) => {
