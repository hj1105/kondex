...
import { normalizeTuiAgentArgsRecord } from '../../../shared/tui-agent-launch-defaults'
...
export function normalizeLoadedGlobalSettings(
  ...
  return {
    ...
    agentCmdOverrides: normalizeTuiAgentArgsRecord(parsed.settings?.agentCmdOverrides),
    ...migratedAgentYoloDefaults,
