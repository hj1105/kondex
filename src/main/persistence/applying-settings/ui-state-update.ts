...
import { mergeContextualTourSeenIds, stripRetiredUIFields } from './ui-interaction-merge'
...
export function updatePersistedUI(
  ...
  const sanitizedUpdates = stripRetiredUIFields(updates)
  ...
  const currentUI = {
    ...getDefaultUIState(),
    ...stripRetiredUIFields(operations.state.ui)
  }
  const previousUI = {
    ...operations.getUI(),
