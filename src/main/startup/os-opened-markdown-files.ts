 ...
 *
 * Main pushes when a window is already live, and the renderer pulls the same buffer when its
 * listener attaches, so a cold-start "Open With" that lands before mount is not dropped.
 */
