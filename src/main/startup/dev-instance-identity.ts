...
const BASE_APP_NAME = 'Kondex'
const BASE_APP_USER_MODEL_ID = 'app.kondex.desktop'
...
export function getDevInstanceIdentity(
  ...
  const repoRoot = cleanEnvValue(env.KONDEX_DEV_REPO_ROOT) ?? cleanEnvValue(env.ORCA_DEV_REPO_ROOT)
