...
//
// Upload stays off because dumps contain process memory. We keep them on disk
// and lift only the text signature out, so a CHECK failure becomes nameable
// without shipping raw memory anywhere.
