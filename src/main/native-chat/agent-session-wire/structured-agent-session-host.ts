...
import { readStructuredAgentSessionSourceSnapshot } from './structured-agent-session-source-snapshot'
...
export class StructuredAgentSessionHost {
  ...
  readJournalSnapshot(sessionId: string) {
    return readStructuredAgentSessionSourceSnapshot(this.requireSession(sessionId))
  }
