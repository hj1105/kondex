...
export class StatsCollector {
   ...
   *
   * Why idempotent: Electron's before-quit can fire multiple times while
   * shutdown is deferred. We close live agents and write, but do NOT clear
   * in-memory state so a second flush() after resumed activity works correctly.
   */
  flush(): void {
