// Secrets scrubber for local diagnostic records and exported support bundles.
// Runs at three locations — sink-write, bundle-collection, and server-ingest;
// the server pass is defense-in-depth since the client runs on an
// attacker-controllable binary, and it additionally drops historical identity keys.
//
...
// Historical identity keys are stripped from local diagnostic bundles to prevent
// retained records from being correlated back to a user.
