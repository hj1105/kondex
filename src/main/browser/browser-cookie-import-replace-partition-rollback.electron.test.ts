...
describe('partitioned cookies under a failed replace-imported-domains import', () => {
  ...
  it(
    'site A: restores a CHIPS cookie with its partition after a later removal rejects',
    async () => {
  ...
  it(
    'site B: restores a CHIPS cookie with its partition after a mid-import set failure',
    async () => {
