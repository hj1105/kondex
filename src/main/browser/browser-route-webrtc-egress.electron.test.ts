...
import { egressProbeTestBudgetMs } from './browser-route-egress-probe-budgets'
import { runBrowserRouteWebrtcEgressProbe } from './browser-route-webrtc-egress-fixture'

describe('browser route WebRTC egress under Electron', () => {
  it(
    'blocks direct UDP after applying the exact guest policy',
    async () => {
