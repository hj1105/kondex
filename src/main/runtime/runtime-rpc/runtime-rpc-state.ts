...
export class RuntimeRpcState {
  ...
  protected runtimeSocketWiring: RuntimeE2EESocketWiring | null = null
  // Why: detaches the current WebSocketTransport from the E2EE session wiring so a
  // pairing rebind can swap transports without orphaning authenticated runtime sockets.
