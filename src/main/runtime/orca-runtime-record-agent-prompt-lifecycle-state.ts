...
import { OrcaRuntimeWithObserveTerminalMetadata } from './orca-runtime-observe-terminal-metadata'
...
export class OrcaRuntimeWithRecordAgentPromptLifecycleState extends OrcaRuntimeWithObserveTerminalMetadata {
