...
describe('OrcaRuntimeService', () => {
  it.each(['native', 'in-process'] as const)(
    'ignores retired Agent Teams setting %s for captured plain Claude resumes',
    async (mode) => {
      ...
      expect(spawnCall?.env?.ORCA_AGENT_TEAMS_TEAM_ID).toBeUndefined()
      expect(spawnCall?.env?.ORCA_AGENT_TEAMS_TOKEN).toBeUndefined()
