...
import { z } from 'zod'
import { BundledSkillInstallRequestSchema } from '../../../../shared/bundled-skill-install-contract'
...
export const SKILL_METHODS: RpcMethod[] = [
  defineMethod({
    name: 'skills.installBundled',
    params: BundledSkillInstallRequestSchema,
    handler: (params, { runtime, signal }) => runtime.installBundledSkills(params, signal)
  }),
  defineMethod({
