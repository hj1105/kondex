import { z } from 'zod'
import { stripRetiredUIFields } from '../../../persistence/applying-settings/ui-interaction-merge'
import {
...
// Retired keys from older clients must not reject unrelated writes in the same batch.
export const UiUpdate = z.preprocess(
  (value) =>
    value && typeof value === 'object' && !Array.isArray(value)
      ? stripRetiredUIFields(value)
      : value,
  z
