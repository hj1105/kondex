...
// Claude Code 2.1.234 trust screen, also covered by terminal-interactive-wait-visibility.
const CLAUDE_TRUST = [
  'Accessing workspace:\n',
  '/private/tmp/repo\n',
...
describe('worker-show interactive wait (STA-3714, STA-4513)', () => {
  ...
  it('reports an explicit null for a live lane without a pending prompt', async () => {
    ...
    const result = await showWorkerPaneServing('Running the test suite...\n')
