...
export type LegacyCheckParams = {
  ...
  compatibilityCliCommand?: 'kondex' | 'kondex-dev' | 'orca' | 'orca-ide' | 'orca-dev'
}
...
export type LegacyAskParams = {
  ...
  timeoutMs?: number
  compatibilityCliCommand?: 'kondex' | 'kondex-dev' | 'orca' | 'orca-ide' | 'orca-dev'
  compatibilityWindowsCommand?: 'kondex' | 'orca' | 'orca-ide'
}
...
export function supportedLegacyHints(
  ...
  cliCommand: 'kondex' | 'kondex-dev' | 'orca' | 'orca-ide' | 'orca-dev'
): string[] {
  if (
