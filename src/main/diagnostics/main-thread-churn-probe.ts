 ...
 * (e.g. a repository scan) with the probe's stall windows and with macOS
 ...
 * probe this never stops: the churn it measures (git status polling and
 * background indexing) is steady-state.
 */
