...
describe('addOrcaWslInteropEnv', () => {
  ...
  it('imports retained hook coordinates without retired provider extensions', () => {
    const env: Record<string, string> = {
    ...
    expect(env.WSLENV).toContain('KONDEX_CLI_COMMAND/u')
  ...
  it('does not register retired OpenCode config overlays even with guest-side paths', () => {
    const env: Record<string, string> = {
