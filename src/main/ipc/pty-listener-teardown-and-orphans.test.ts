...
describe('registerPtyHandlers', () => {
  ...
  it('cleans up account and migration state when a PTY is killed', async () => {
    ...
    expect(forgetCodexPaneAccountMock).toHaveBeenCalledWith(spawnResult.id)
    expect(clearMigrationUnsupportedPtyMock).toHaveBeenCalledWith(spawnResult.id)
  })
