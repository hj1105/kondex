...
export const NATIVE_CHAT_SUPPORTED_AGENT_LIST: readonly TuiAgent[] = ['claude', 'codex']
...
export function nativeChatRequiresLocalTranscript(_agent: string | null | undefined): boolean {
  return false
}
