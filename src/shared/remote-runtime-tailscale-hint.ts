...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote (?:orca|kondex) runtime|remote (?:orca|kondex) runtime closed the connection|timed out (?:waiting for|while connecting to) the remote (?:orca|kondex) runtime/i
