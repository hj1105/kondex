...
describe('tab title resolution', () => {
  ...
  it('does not give retired OpenCode session titles priority over generated titles', () => {
    expect(
      resolveTerminalTabTitle(
        {
          customTitle: null,
  ...
  it('keeps retained session and generated titles ahead of retired native titles', () => {
    const aiVaultTitle = {
  ...
  it('does not give retired native labels priority over generated unified labels', () => {
    expect(
      resolveUnifiedTabLabel(
        {
          customLabel: null,
