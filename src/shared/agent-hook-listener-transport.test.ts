...
describe('shared agent-hook-listener', () => {
  ...
  it('routes pathnames to a known source or null', () => {
    ...
    expect(resolveHookSource('/hook/antigravity')).toBeNull()
    expect(resolveHookSource('/hook/grok')).toBeNull()
    expect(resolveHookSource('/hook/hermes')).toBeNull()
    expect(resolveHookSource('/hook/pi')).toBeNull()
    ...
    expect(resolveHookSource('/hook/mimo-code')).toBeNull()
