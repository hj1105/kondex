...
// COMPAT(retiredEphemeralVmRuntime): old profiles can contain SSH targets owned
// by the removed VM provisioner. The renderer cannot read target.owner, so this
// prefix keeps those records hidden and prevents reconnection.
