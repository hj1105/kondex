...
export const runtimeEnvironmentsApi = {
  listLocalNetworkInterfaces: (): Promise<{
    interfaces: { name: string; address: string; hasDefaultRoute?: boolean }[]
  }> => ipcRenderer.invoke('runtimeEnvironments:listLocalNetworkInterfaces'),
  createLocalAccessLink: (args) =>
    ipcRenderer.invoke('runtimeEnvironments:createLocalAccessLink', args),
  listLocalAccessGrants: () => ipcRenderer.invoke('runtimeEnvironments:listLocalAccessGrants'),
  revokeLocalAccessGrant: (args) =>
    ipcRenderer.invoke('runtimeEnvironments:revokeLocalAccessGrant', args),
